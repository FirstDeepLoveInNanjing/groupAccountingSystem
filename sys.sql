/*
 ...
 Source Server         : group_acount_system
...
CREATE TABLE `activitymember`  (
  `activityID` int NOT NULL COMMENT '项目ID',
  `memberID` int NOT NULL COMMENT '成员ID，外键关联User(userID)',
  `role` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '角色',
  `confirmAttendStatus` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '是否确认项目',
  `confirmTime` datetime NULL DEFAULT NULL COMMENT '确认时间',
  PRIMARY KEY (`activityID`, `memberID`) USING BTREE,
  INDEX `memberID`(`memberID` ASC) USING BTREE,
  CONSTRAINT `activitymember_ibfk_1` FOREIGN KEY (`activityID`) REFERENCES `groupactivity` (`activityID`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `activitymember_ibfk_2` FOREIGN KEY (`memberID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE `collect`  (
  `activityID` int NOT NULL COMMENT '项目ID，主键',
  `amount` decimal(10, 2) NOT NULL COMMENT '收费金额',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '收费说明',
  `initiatorID` int NOT NULL COMMENT '收费发起人ID，外键关联User(userID)',
  `targetUsers` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '收费对象（可存储多个用户ID，逗号分隔或JSON）',
  `createTime` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CollectStatus` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '完成状态',
  PRIMARY KEY (`activityID`) USING BTREE,
  INDEX `initiatorID`(`initiatorID` ASC) USING BTREE,
  CONSTRAINT `collect_ibfk_1` FOREIGN KEY (`activityID`) REFERENCES `groupactivity` (`activityID`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `collect_ibfk_2` FOREIGN KEY (`initiatorID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '收费管理表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for groupactivity
-- ----------------------------
DROP TABLE IF EXISTS `groupactivity`;
CREATE TABLE `groupactivity`  (
  `activityID` int NOT NULL AUTO_INCREMENT COMMENT '项目ID，主键',
  `activityName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '项目名称',
  ...
  `actualAmount` decimal(10, 2) NULL DEFAULT NULL COMMENT '实际总金额',
  `creatorID` int NOT NULL COMMENT '创建者ID，外键关联User(userID)',
  `createTime` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `settlementTime` datetime NULL DEFAULT NULL COMMENT '结算时间',
  `isSettable` tinyint(1) NULL DEFAULT 0 COMMENT '是否可结算',
  `confirmDeadline` datetime NULL DEFAULT NULL COMMENT '确认截止时间',
  `maxMember` int NULL DEFAULT NULL COMMENT '最大成员数',
  PRIMARY KEY (`activityID`) USING BTREE,
  INDEX `creatorID`(`creatorID` ASC) USING BTREE,
  CONSTRAINT `groupactivity_ibfk_1` FOREIGN KEY (`creatorID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '团体项目表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of groupactivity
-- ----------------------------
...
CREATE TABLE `pay`  (
  `payID` int NOT NULL AUTO_INCREMENT COMMENT '支付ID，主键',
  `activityID` int NOT NULL COMMENT '项目ID',
  `userID` int NOT NULL COMMENT '用户ID',
  `payAmount` decimal(10, 2) NOT NULL COMMENT '支付金额',
  `payStatus` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '支付状态',
  `payMethod` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '支付方式',
  `payTime` datetime NULL DEFAULT NULL COMMENT '支付时间',
  `payRemark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '支付备注',
  `paymentProofPath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '付款凭证图片路径',
  PRIMARY KEY (`payID`) USING BTREE,
  INDEX `activityID`(`activityID` ASC) USING BTREE,
  INDEX `userID`(`userID` ASC) USING BTREE,
  CONSTRAINT `pay_ibfk_1` FOREIGN KEY (`activityID`) REFERENCES `groupactivity` (`activityID`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `pay_ibfk_2` FOREIGN KEY (`userID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE `report`  (
  `reportID` int NOT NULL AUTO_INCREMENT COMMENT '举报ID，主键',
  `reporterID` int NOT NULL COMMENT '举报者ID，外键关联User(userID)',
  `accusedActivityID` int NOT NULL COMMENT '举报的违规项目ID，外键关联GroupActivity(activityID)',
  `accusedUserID` int NOT NULL COMMENT '被举报用户ID，外键关联User(userID)',
  `reportReason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '举报内容',
  `reportTime` date NULL DEFAULT NULL COMMENT '举报时间',
  `reportProcessStatus` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '举报处理状态',
  `punishmentType` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '处罚类型：警告/封号1天/封号7天/封号365天',
  `punishmentEndTime` datetime NULL DEFAULT NULL COMMENT '封号截止时间',
  PRIMARY KEY (`reportID`) USING BTREE,
  INDEX `reporterID`(`reporterID` ASC) USING BTREE,
  INDEX `accusedActivityID`(`accusedActivityID` ASC) USING BTREE,
  INDEX `accusedUserID`(`accusedUserID` ASC) USING BTREE,
  CONSTRAINT `report_ibfk_1` FOREIGN KEY (`reporterID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `report_ibfk_2` FOREIGN KEY (`accusedActivityID`) REFERENCES `groupactivity` (`activityID`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `report_ibfk_3` FOREIGN KEY (`accusedUserID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE RESTRICT
...
-- ----------------------------
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables', 'OFF', '2026-04-27 20:58:44', NULL);
INSERT INTO `sys_config` VALUES ('diagnostics.include_raw', 'OFF', '2026-04-27 20:58:44', NULL);
INSERT INTO `sys_config` VALUES ('ps_thread_trx_info.max_length', '65535', '2026-04-27 20:58:44', NULL);
INSERT INTO `sys_config` VALUES ('statement_performance_analyzer.limit', '100', '2026-04-27 20:58:44', NULL);
INSERT INTO `sys_config` VALUES ('statement_performance_analyzer.view', NULL, '2026-04-27 20:58:44', NULL);
INSERT INTO `sys_config` VALUES ('statement_truncate_len', '64', '2026-04-27 20:58:44', NULL);
...
CREATE TABLE `user`  (
  ...
  `userPassword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '登录密码',
  `userType` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户类型（普通用户/管理员）',
  `PhoneNumber` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '联系电话',
  `userMailbox` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '邮箱地址',
  ...
  `Birthday` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户生日',
  `RegisterTime` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '注册时间',
  `paymentQrCodePath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '收款码图片路径',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin123', '管理员', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-13 21:27:07', NULL);
INSERT INTO `user` VALUES (2, 'user123', '普通用户', '13812345678', 'zhangsan@example.com', '张三', '张小明', '320101199001011234', '男', '1990-01-01', '2026-05-13 21:27:16', NULL);
INSERT INTO `user` VALUES (3, 'user123', '普通用户', '123456', 'zhangsan@abc.com', '李四', NULL, NULL, NULL, NULL, '2026-05-15 18:08:49', NULL);
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY INVOKER VIEW `version` AS select '2.1.3' AS `sys_version`,version() AS `mysql_version`;
